...
{    int V;
	...
	for(i=0;i<m;i++)      //Indexing ranges from 1 to n
          
          { int temp,temp1,weight;
          cin>>temp>>temp1>>weight;
            cost[temp][temp1]=weight;
            cost[temp1][temp]=weight;
			//Absence of edge between vertices i and j is represented by INFINITY
             if(cost[temp][temp1]==0||cost[temp][temp1]==0)     
               cost[temp][temp1]=INFINITY;
               cost[temp1][temp]=INFINITY;
